const app = {
    ...
    fetchProducts: async function() {
        ...
        try {
            ...
            productList.innerHTML = `<p style="padding: 20px; color: red;">Грешка при зареждане.</p>`;
        }
    },
        ...
        products.forEach(p => {
            ...
            <article class="product-card" style="display: flex; position: relative; padding: 15px; border-bottom: 1px solid #eee; background: #fff;">
                ...
                <div style="flex: 0 0 120px; text-align: center; margin-right: 15px; margin-top: 20px;">
                    ...
                    <div style="font-size: 0.8rem; font-weight: bold; color: #888; text-transform: uppercase; letter-spacing: 0.5px;">Samsung Galaxy</div>
                    <div style="font-weight: bold; font-size: 1.2rem; margin-top: 5px; color: #e83e8c;">${p.price}</div>
                ...
                <div style="flex: 1; border-left: 1px dashed #ddd; padding-left: 15px;">
                    ...
                    <a href="${p.link}" target="_blank" class="buy-btn" style="display: inline-flex; align-items: center; gap: 8px; background: #2ecc71; color: white; padding: 8px 18px; border-radius: 6px; text-decoration: none; font-weight: bold; margin-bottom: 15px; font-size: 0.9rem;">
                    ...
                    <ul class="product-actions" style="list-style: none; padding: 0; margin: 0 0 15px 0;">
                        ...
                        <li style="color: #6c757d; font-size: 0.85rem; margin-bottom: 8px; cursor: pointer; display: flex; align-items: center; gap: 10px;">
                    ...
                    <a href="${p.link}" class="shop-link" target="_blank" style="display: flex; align-items: center; gap: 10px; background: #f1f3f5; padding: 10px; border-radius: 8px; text-decoration: none; color: #333; font-weight: bold; font-size: 0.85rem; margin-top: 10px;">
