const app = {
    ...
    categoryIcons: {
        ...
        "Footwear": '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 11V9a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v4"/><path d="M20 19H4a2 2 0 0 1-2-2v-1.1a2 2 0 0 1 1.7-1.9l14.6-2.9a2 2 0 0 1 2.3 1.4v2.5a2 2 0 0 1-2 2Z"/></svg>', // Lucide-style Sneaker
        ...
        "Second Hand": '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.38 3.4a2 2 0 0 0-1.2-1.2a2 2 0 0 0-1.44.24l-4.5 2.5a2 2 0 0 1-1.92 0l-4.5-2.5a2 2 0 0 0-1.44-.24a2 2 0 0 0-1.2 1.2L2 9v11a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9Z"/><path d="M9 21v-6a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v6"/></svg>', // Lucide-style Shirt
        "Sports": '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M5 5a10 10 0 0 0 14 0"/><path d="M5 19a10 10 0 0 1 14 0"/></svg>', // Minimal tennis-like curves
    },
