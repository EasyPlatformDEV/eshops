const app = {
    ...
    categoryIcons: {
        ...
        "Footwear": '<svg viewBox="0 0 24 24"><path d="M18 10h-1c-.55 0-1 .45-1 1v4h2v-4c0-.55-.45-1-1-1zM4 12c0 2.76 2.24 5 5 5h10c.55 0 1-.45 1-1s-.45-1-1-1c0-1.66-1.34-3-3-3H9.5C7.57 12 6 10.43 6 8.5V6H4v6zm13.5-3c-1.38 0-2.5 1.12-2.5 2.5V13h5v-1.5c0-1.38-1.12-2.5-2.5-2.5z" fill="currentColor"/></svg>', // Standard Running Shoe
