    ...
    renderProducts: function(products) {
        ...
        products.forEach(p => {
            ...
            <article class="product-card" style="display: flex; position: relative; padding: 15px; border-bottom: 1px solid #eee; background: #fff;">
                ...
                <div class="delete-icon" style="position: absolute; left: 15px; top: 15px; color: #ccc; cursor: pointer; z-index: 10;">
                ...
                <div style="flex: 0 0 120px; text-align: center; margin-right: 15px; padding-top: 35px;">
                    <img src="${p.image}" alt="${p.title}" style="width: 100px; height: 100px; object-fit: contain; margin-bottom: 10px;">
                    
                    <div style="font-size: 0.75rem; font-weight: bold; color: #999; text-transform: uppercase; margin-bottom: 4px;">${p.brand || 'Brand'}</div>
                    
                    <div style="font-weight: bold; font-size: 1.2rem; color: #e83e8c;">${p.price}</div>
                ...
                <div style="flex: 1; border-left: 1px dashed #ddd; padding-left: 15px;">
                    ...
                    <a href="${p.link}" target="_blank" class="buy-btn" style="display: inline-flex; align-items: center; gap: 8px; background: #2ecc71; color: white; padding: 8px 15px; border-radius: 5
