const app = {
    ...
    categoryIcons: {
        ...
        "Footwear": '<svg viewBox="0 0 24 24"><path d="M21.5 9.5c-1.8-1.8-4.2-2.3-6.5-1.7-1 .2-1.8-.7-1.5-1.7 1.3-3.6-2.5-6.5-5.6-4.3C5.9 3.2 2 8 2 13v3c0 2.2 1.8 4 4 4h14c1.1 0 2-.9 2-2v-4.5c0-1.5-.7-3-2.5-4zM6 18c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z" fill="currentColor"/></svg>', // Generic Shoe Profile
        ...
        "Second Hand": '<svg viewBox="0 0 24 24"><path d="M21 6a1 1 0 0 0-1-1h-6.17a3.001 3.001 0 0 1-5.66 0H2a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h1v11a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1V10h1a1 1 0 0 0 1-1V6z" fill="currentColor"/></svg>', // Moved T-shirt here
        "Sports": '<svg viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm5.72 15.28c-2.58-.98-4.66-3.13-5.51-5.79.85-2.66 2.93-4.81 5.51-5.79.84 2.22 1.28 4.63 1.28 7.09 0 1.58-.18 3.11-.51 4.58.01-.03-.77.16-1.28-.09zM6.28 8.72C8.86 9.7 10.94 11.85 11.79 14.51c-.85 2.66-2.93 4.81-5.51 5.79-.33-1.47-.51-3-.51-4.58 0-2.46.44-4.87 1.28-7.09.52.25-1.28-.09-1.28.09z" fill="currentColor"/></svg>',
    },
