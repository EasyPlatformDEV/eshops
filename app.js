const app = {
    ...
    categoryIcons: {
        ...
        "Clothing": '<svg viewBox="0 0 24 24"><path d="M21 6a1 1 0 0 0-1-1h-6.17a3.001 3.001 0 0 1-5.66 0H2a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h1v11a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1V10h1a1 1 0 0 0 1-1V6z" fill="currentColor"/></svg>', // Simple T-Shirt
        ...
        "Sports": '<svg viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm6.65 4.09c.8 1.63 1.25 3.45 1.25 5.37 0 .22-.01.44-.02.65-2.22-.64-4.52.12-5.59 2.12-.13.24-.24.49-.33.75-2.27.67-4.83.1-6.03-1.71-.48-.73-.83-1.54-1.02-2.39 1.83-2.07 4.57-2.32 6.66-.99.53.33 1.02.73 1.45 1.18.23-.27.47-.53.73-.77 2-1.87 2.5-3.33 2.9-4.21z" fill="currentColor"/></svg>', // Tennis Ball Curve Pattern
    },
