const app = {
    ...
    categoryIcons: {
        ...
        "Alcohol": '<svg viewBox="0 0 24 24"><path d="M11 21v-5.18c-2.31-.56-4-2.65-4-5.13V5c0-1.65 1.35-3 3-3s3 1.35 3 3v5.69c0 2.48-1.69 4.57-4 5.13V21h-2zM9 5v5.69c0 1.65 1.35 3 3 3s3-1.35 3-3V5c0-.55-.45-1-1-1s-1 .45-1 1v4H11V5c0-.55-.45-1-1-1s-1 .45-1 1z" fill="currentColor"/></svg>', // Simple Wine Glass
        ...
        "Beauty": '<svg viewBox="0 0 24 24"><path d="M12 2c2.21 0 4 1.79 4 4 0 1.55-.89 2.9-2.2 3.58l.72 1.43 1.48 2.95V22H8v-8.04l2.2-4.39C8.89 8.9 8 7.55 8 6c0-2.21 1.79-4 4-4zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm-3 12v4h6v-4H9z" fill="currentColor"/></svg>', // Clearer Perfume Bottle shape
        ...
        "Footwear": '<svg viewBox="0 0 24 24"><path d="M19 14.5c0-2-1.5-3.5-3-3.5h-2c-1.1 0-2-.9-2-2s.9-2 2-2h.1l1.9-5.7C15.8 1.1 15.6 1 15.4 1H6.6C6.4 1 6.2 1.1 6 1.3L4.1 7h.1c1.1 0 2 .9 2 2s-.9 2-2 2H2v8.5c0 1.9 1.6 3.5 3.5 3.5h13c1.9 0 3.5-1.6 3.5-3.5V14.5zM6 19c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z" fill="currentColor"/></svg>', // Optimizing Sneaker - High Top Profile (Clearer)
        ...
        "Pets": '<svg viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z" fill="currentColor"/><path d="M8 10l-2-3 2-1 1 2h6l1-2 2 1-2 3v4c0 2.21-1.79 4-4 4s-4-1.79-4-4v-4z" fill="white" transform="translate(0, 1)"/></svg>', // Cat Head Silhouette inside circle (inverted color for visibility)
        ...
        "Second Hand": '<svg viewBox="0 0 24 24"><path d="M21 13V9c0-2.8-2.2-5-5-5h-3v2h3c1.7 0 3 1.3 3 3v4H7c-2.8 0-5 2.2-5 5v3h15.9l2-5h-3l-2 5H4v-3c0-1.7 1.3-3 3-3h14z" fill="currentColor"/></svg>', // Steam Iron Profile
        "Sports": '<svg viewBox="0 0 24 24"><path d="M14.5 11.2c.4-.9.6-2 .6-2.9 0-3.9-3.3-7.2-7.2-7.2S.7 4.5.7 8.3c0 3.8 3.3 7 7.2 7 .9 0 2-.2 2.9-.6l6.4 6.4c.4.4 1 .4 1.4 0l2.1-2.1c.4-.4.4-1 0-1.4l-6.2-6.4zm-6.6 2c-2.7 0-4.9-2.2-4.9-4.9S5.2 3.5 7.9 3.5 12.8 5.7 12.8 8.3s-2.2 4.9-4.9 4.9z" fill="currentColor"/></svg>', // Standard Racket shape
    },
