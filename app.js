const app = {
    ...
    categoryIcons: {
        ...
        "Footwear": '<svg viewBox="0 0 24 24"><path d="M22.06 17.15L20.6 8.52c-.17-.96-1-1.63-1.99-1.52L17.5 7.1V5c0-1.1-.9-2-2-2h-3c-1.1 0-2 .9-2 2v2.24l-3.23.54c-.95.16-1.62 1.05-1.48 2.02l.66 4.63-4.22.7c-1.14.19-2.03 1.15-2.09 2.3L2 19h20l.06-1.85zM6.5 17c-.83 0-1.5-.67-1.5-1.5S5.67 14 6.5 14s1.5.67 1.5 1.5S7.33 17 6.5 17z" fill="currentColor"/></svg>', // Sneaker Side View
