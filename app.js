        ...
        products.forEach(p => {
            ...
            <article style="display: flex; position: relative; padding: 15px; border-bottom: 1px solid #eee; background: #fff; font-family: sans-serif;">
                ...
                <div style="flex: 1; border-left: 1px dashed #ddd; padding-left: 15px;">
                    ...
                    <a href="${p.link}" target="_blank" style="display: inline-flex; align-items: center; gap: 8px; color: white; padding: 8px 18px; border-radius: 6px; text-decoration: none; font-weight: bold; margin-bottom: 15px; font-size: 0.9rem;">
